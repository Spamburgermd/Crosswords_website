...
class DictionarySlotEnum(str, Enum):
    """Accepted dictionary ids and legacy aliases."""
    CORE = "CORE"
    STANDARD = "STANDARD"
    ADVANCED = "ADVANCED"
    CANON = "CANON"
...
class CreateGameIn(BaseModel):
    dictionary_slot: Optional[str] = None  # defaults to STANDARD when omitted
...
class GameStateOut(BaseModel):
    ...
    # NEW for serverless scoring: optional exposure of opponent target words + dictionary metadata.
    target_words: Optional[List[str]] = None
    dictionary_version: Optional[str] = None
    target_seed: Optional[int] = None  # reserved for future deterministic regeneration approach
