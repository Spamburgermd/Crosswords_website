...
3. **Word lists**: The server uses tiered dictionary files in `data/`.
   - target selection uses `tier_core_4_6.json`, `tier_standard_4_6.json`, `tier_advanced_4_6.json`, or `tier_canon_4_6.json`
   - guess validation always uses `tier_canon_4_6.json`
   - legacy ids still normalize: `common -> core`, `modified -> standard`, `twl -> canon`
