/**
 * src/lib/localValidateWordset.ts
 * -----------------------------------------------------------
 * Client-side mirror of server validate_wordset rules.
 * Rules today:
 * - exactly 5 words
 * - lengths: 2 words of length 4, 2 words of length 5, 1 word of length 6
 * - all words unique
 * - letters A-Z only (uppercase normalized)
 */
